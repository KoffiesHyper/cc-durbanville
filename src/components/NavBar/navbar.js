    ...
    return(
        <div className="navbar w-full bg-black h-16">
            <div className="nav-left items-center h-full">
                <img 
                src="https://static.wixstatic.com/media/21700f_4fe9bba072b746cab141a86d4b28edf8~mv2_d_1478_1300_s_2.png/v1/fit/w_2500,h_1330,al_c/21700f_4fe9bba072b746cab141a86d4b28edf8~mv2_d_1478_1300_s_2.png"
                width={75}
                />
